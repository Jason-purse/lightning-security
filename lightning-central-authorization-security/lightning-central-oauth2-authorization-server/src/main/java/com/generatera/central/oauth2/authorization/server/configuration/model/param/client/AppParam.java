package com.generatera.central.oauth2.authorization.server.configuration.model.param.client;

import com.generatera.authorization.server.common.configuration.model.param.AuthServerParam;
...
@AllArgsConstructor
@NoArgsConstructor
public class AppParam implements AuthServerParam, IdSupport<Long> {
