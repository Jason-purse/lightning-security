 ...
 */
public class AllowPartialCacheMethodSecurityMetadataSource extends AbstractMethodSecurityMetadataSource {
    ...
    private Collection<ConfigAttribute> getConfigAttributes(Method method, Class<?> targetClass, DefaultCacheKey cacheKey) {
        ...
        for (MethodSecurityMetadataSource s : this.methodSecurityMetadataSources) {
            ...
            if (aBoolean) {
                return getCachedConfigAttributes(cacheKey);
            }
    ...
    private Collection<ConfigAttribute> getCachedConfigAttributes(DefaultCacheKey cacheKey) {
