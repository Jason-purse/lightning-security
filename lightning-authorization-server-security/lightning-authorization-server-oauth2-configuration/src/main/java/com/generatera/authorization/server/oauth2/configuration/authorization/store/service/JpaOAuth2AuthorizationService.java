package com.generatera.authorization.server.oauth2.configuration.authorization.store.service;
...
import com.generatera.authorization.server.oauth2.configuration.model.entity.JpaOAuth2AuthorizationEntity;
import com.generatera.authorization.server.oauth2.configuration.model.ext.AuditDeletedDate;
...
import com.generatera.authorization.server.oauth2.configuration.model.ext.mixin.AuditDeletedDateMixin;
import com.generatera.authorization.server.oauth2.configuration.model.ext.mixin.LongMixin;
import com.generatera.authorization.server.oauth2.configuration.model.ext.mixin.UserAuthorityMixin;
import com.generatera.authorization.server.oauth2.configuration.model.ext.mixin.UserPrincipalMixin;
import com.generatera.authorization.server.oauth2.configuration.util.OAuth2Util;
