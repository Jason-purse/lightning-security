...
import com.generatera.authorization.server.common.configuration.authorization.store.repository.OAuth2AuthorizationRepository;
import com.generatera.authorization.server.common.configuration.model.entity.JpaOAuth2AuthorizationEntity;
import com.generatera.authorization.server.common.configuration.model.ext.AuditDeletedDate;
...
import com.generatera.authorization.server.common.configuration.model.ext.mixin.AuditDeletedDateMixin;
import com.generatera.authorization.server.common.configuration.model.ext.mixin.LongMixin;
import com.generatera.authorization.server.common.configuration.model.ext.mixin.UserAuthorityMixin;
import com.generatera.authorization.server.common.configuration.model.ext.mixin.UserPrincipalMixin;
import com.generatera.authorization.server.common.configuration.util.OAuth2Util;
