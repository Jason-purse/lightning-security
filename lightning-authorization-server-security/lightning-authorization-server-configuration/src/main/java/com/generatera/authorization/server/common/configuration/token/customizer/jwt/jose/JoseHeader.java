...
import com.generatera.authorization.server.common.configuration.token.customizer.jwt.JwaAlgorithm;
...
class JoseHeader {
    ...
    abstract static class AbstractBuilder<T extends JoseHeader, B extends JoseHeader.AbstractBuilder<T, B>> {
