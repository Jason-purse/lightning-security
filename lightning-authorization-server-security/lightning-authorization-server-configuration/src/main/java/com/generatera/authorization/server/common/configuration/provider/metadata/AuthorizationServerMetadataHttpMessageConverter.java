...
public class AuthorizationServerMetadataHttpMessageConverter extends AbstractHttpMessageConverter<AuthorizationServerMetadata> {
    private static final ParameterizedTypeReference<Map<String, Object>> STRING_OBJECT_MAP = new ParameterizedTypeReference<Map<String, Object>>() {
    };
    private final GenericHttpMessageConverter<Object> jsonMessageConverter = HttpMessageConverters.getJsonMessageConverter();
    private Converter<Map<String, Object>, AuthorizationServerMetadata> authorizationServerMetadataConverter = new AuthorizationServerMetadataHttpMessageConverter.OAuth2AuthorizationServerMetadataConverter();
    private Converter<AuthorizationServerMetadata, Map<String, Object>> authorizationServerMetadataParametersConverter = source -> source.getClaims();

    public AuthorizationServerMetadataHttpMessageConverter() {
        super(MediaType.APPLICATION_JSON, new MediaType("application", "*+json"));
    }

    protected boolean supports(Class<?> clazz) {
        return AuthorizationServerMetadata.class.isAssignableFrom(clazz);
    }

    protected AuthorizationServerMetadata readInternal(Class<? extends AuthorizationServerMetadata> clazz, HttpInputMessage inputMessage) throws HttpMessageNotReadableException {
        try {
            ...
            return (AuthorizationServerMetadata)this.authorizationServerMetadataConverter.convert(authorizationServerMetadataParameters);
    ...
    protected void writeInternal(AuthorizationServerMetadata authorizationServerMetadata, HttpOutputMessage outputMessage) throws HttpMessageNotWritableException {
        try {
    ...
    public final void setAuthorizationServerMetadataConverter(Converter<Map<String, Object>, AuthorizationServerMetadata> authorizationServerMetadataConverter) {
    ...
    public final void setAuthorizationServerMetadataParametersConverter(Converter<AuthorizationServerMetadata, Map<String, Object>> authorizationServerMetadataParametersConverter) {
    ...
    private static final class OAuth2AuthorizationServerMetadataConverter implements Converter<Map<String, Object>, AuthorizationServerMetadata> {
        ...
        public AuthorizationServerMetadata convert(Map<String, Object> source) {
            Map<String, Object> parsedClaims = this.claimTypeConverter.convert(source);
            return AuthorizationServerMetadata.withClaims(parsedClaims).build();
        }
