 ...
 */
@Data
public class LightningFormLoginAuthenticationEntryPoint implements LightningAuthenticationEntryPoint {
    ...
    public LightningFormLoginAuthenticationEntryPoint(FormLoginTokenGenerator tokenGenerator,
