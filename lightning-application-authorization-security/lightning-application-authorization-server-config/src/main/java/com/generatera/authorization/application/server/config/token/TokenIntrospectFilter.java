...
public class TokenIntrospectFilter extends OncePerRequestFilter {
    ...
    public TokenIntrospectFilter(AuthenticationManager authenticationManager) {
        this(authenticationManager, DEFAULT_TOKEN_INTROSPECTION_ENDPOINT_URI);
    }

    public TokenIntrospectFilter(AuthenticationManager authenticationManager, String tokenIntrospectionEndpointUri) {
