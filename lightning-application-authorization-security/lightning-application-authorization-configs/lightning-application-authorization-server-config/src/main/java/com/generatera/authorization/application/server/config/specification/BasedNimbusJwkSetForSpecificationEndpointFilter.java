 ...
 */
public final class BasedNimbusJwkSetForSpecificationEndpointFilter extends OncePerRequestFilter {
    ...
    public BasedNimbusJwkSetForSpecificationEndpointFilter(JWKSource<SecurityContext> jwkSource) {
        this(jwkSource, "/oauth2/jwks");
    }

    public BasedNimbusJwkSetForSpecificationEndpointFilter(JWKSource<SecurityContext> jwkSource, String jwkSetEndpointUri) {
