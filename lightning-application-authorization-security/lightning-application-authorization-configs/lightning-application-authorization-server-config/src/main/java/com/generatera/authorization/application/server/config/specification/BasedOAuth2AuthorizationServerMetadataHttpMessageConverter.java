...
public class BasedOAuth2AuthorizationServerMetadataHttpMessageConverter extends AbstractHttpMessageConverter<BasedOAuth2AuthorizationServerMetadata> {
    private static final ParameterizedTypeReference<Map<String, Object>> STRING_OBJECT_MAP = new ParameterizedTypeReference<Map<String, Object>>() {
    };
    private final GenericHttpMessageConverter<Object> jsonMessageConverter = HttpMessageConverters.getJsonMessageConverter();
    private Converter<Map<String, Object>, BasedOAuth2AuthorizationServerMetadata> authorizationServerMetadataConverter = new BasedOAuth2AuthorizationServerMetadataHttpMessageConverter.OAuth2AuthorizationServerMetadataConverter();
    private Converter<BasedOAuth2AuthorizationServerMetadata, Map<String, Object>> authorizationServerMetadataParametersConverter = source -> source.getClaims();

    public BasedOAuth2AuthorizationServerMetadataHttpMessageConverter() {
        super(MediaType.APPLICATION_JSON, new MediaType("application", "*+json"));
    }

    protected boolean supports(Class<?> clazz) {
        return BasedOAuth2AuthorizationServerMetadata.class.isAssignableFrom(clazz);
    }

    protected BasedOAuth2AuthorizationServerMetadata readInternal(Class<? extends BasedOAuth2AuthorizationServerMetadata> clazz, HttpInputMessage inputMessage) throws HttpMessageNotReadableException {
        try {
            ...
            return (BasedOAuth2AuthorizationServerMetadata)this.authorizationServerMetadataConverter.convert(authorizationServerMetadataParameters);
    ...
    protected void writeInternal(BasedOAuth2AuthorizationServerMetadata authorizationServerMetadata, HttpOutputMessage outputMessage) throws HttpMessageNotWritableException {
        try {
    ...
    public final void setAuthorizationServerMetadataConverter(Converter<Map<String, Object>, BasedOAuth2AuthorizationServerMetadata> authorizationServerMetadataConverter) {
    ...
    public final void setAuthorizationServerMetadataParametersConverter(Converter<BasedOAuth2AuthorizationServerMetadata, Map<String, Object>> authorizationServerMetadataParametersConverter) {
    ...
    private static final class OAuth2AuthorizationServerMetadataConverter implements Converter<Map<String, Object>, BasedOAuth2AuthorizationServerMetadata> {
        ...
        public BasedOAuth2AuthorizationServerMetadata convert(Map<String, Object> source) {
            Map<String, Object> parsedClaims = this.claimTypeConverter.convert(source);
            return BasedOAuth2AuthorizationServerMetadata.withClaims(parsedClaims).build();
        }
