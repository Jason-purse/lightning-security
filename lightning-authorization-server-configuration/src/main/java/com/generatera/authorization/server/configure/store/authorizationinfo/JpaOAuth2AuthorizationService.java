...
import com.generatera.authorization.server.configure.model.ext.mixin.AuditDeletedDateMixin;
import com.generatera.authorization.server.configure.model.ext.mixin.LongMixin;
import com.generatera.authorization.server.configure.model.ext.mixin.UserAuthorityMixin;
import com.generatera.authorization.server.configure.model.ext.mixin.UserPrincipalMixin;
import com.generatera.authorization.server.configure.store.authorizationinfo.repository.OAuth2AuthorizationRepository;
import com.generatera.authorization.server.configure.util.OAuth2Util;
